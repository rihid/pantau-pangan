...
This is a pinned shortcut for `{{command_prefix}}impeccable distill`.

Invoke {{command_prefix}}impeccable distill, passing along any arguments provided here, and follow its instructions.
