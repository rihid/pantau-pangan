...
This is a pinned shortcut for `{{command_prefix}}impeccable colorize`.

Invoke {{command_prefix}}impeccable colorize, passing along any arguments provided here, and follow its instructions.
