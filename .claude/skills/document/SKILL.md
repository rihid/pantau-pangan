...
This is a pinned shortcut for `{{command_prefix}}impeccable document`.

Invoke {{command_prefix}}impeccable document, passing along any arguments provided here, and follow its instructions.
