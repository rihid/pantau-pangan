...
This is a pinned shortcut for `{{command_prefix}}impeccable polish`.

Invoke {{command_prefix}}impeccable polish, passing along any arguments provided here, and follow its instructions.
