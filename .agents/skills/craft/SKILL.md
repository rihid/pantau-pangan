...
This is a pinned shortcut for `{{command_prefix}}impeccable craft`.

Invoke {{command_prefix}}impeccable craft, passing along any arguments provided here, and follow its instructions.
