...
This is a pinned shortcut for `{{command_prefix}}impeccable onboard`.

Invoke {{command_prefix}}impeccable onboard, passing along any arguments provided here, and follow its instructions.
