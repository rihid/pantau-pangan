...
This is a pinned shortcut for `{{command_prefix}}impeccable quieter`.

Invoke {{command_prefix}}impeccable quieter, passing along any arguments provided here, and follow its instructions.
